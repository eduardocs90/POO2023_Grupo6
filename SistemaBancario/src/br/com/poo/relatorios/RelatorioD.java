...
public class RelatorioD extends AbstractTableModel {
    private static final long serialVersionUID = 1L;
    private static final String[] COLUNAS = {"Numero da Conta", "Cpf", "N°Agencia"};
    private String numAgencia;
    private List<Conta> contasFiltradas;

    public RelatorioD(String numAgencia) {
